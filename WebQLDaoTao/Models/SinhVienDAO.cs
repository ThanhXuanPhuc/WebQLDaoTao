...
namespace WebQLDaoTao.Models
{
    public class SinhVienDAO
    {
        public int Insert(SinhVien sv)
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("insert into sinhvien (masv, hosv, tensv, gioitinh,ngaysinh, noisinh, diachi, makh)"
                + "values(@masv, @hosv, @tensv, @gioitinh, @ngaysinh, @noisinh, @diachi, @makh)", conn);
